...
func (c *companyRepository) CreateOrUpdate(ctx context.Context, company *model.Company, id int) (*model.Company, error) {
...
func (c *companyRepository) DebitBalance(ctx context.Context, amount int, note string) error {
	...
	// [DONE] TODO: tuliskan baris code untuk mengurangi balance
